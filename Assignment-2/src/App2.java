public class App2 {
    public static void main(String[] args) {
        ...
        System.out.println("Longest decreasing subsequence: " + decSubSeq(seq1));
        ...
        System.out.println("Longest decreasing subsequence: " + decSubSeq(seq2));
        ...
        System.out.println("Longest decreasing subsequence: " + decSubSeq(seq3));
    }

    public static int decSubSeq(int[] seq) {
